...
class Ahorcado():
    ...
    def un_jugador(self):
        ...
        dificultad = int(input(
            "Ingrese una dificultad del 1 al 10"
            "(1 --> dificil, 10 --> facil): "
            ))
        partida = Partida(pal['palabra'], dificultad*len(pal['palabra']), pal[
            'tipo_palabra'
            ], nombre)
        while partida._intentos > 0:
            ...
            if result == 'Gano':
                print(
                    result,
                    '! Felicitaciones, la palabra era: ', partida._palabra)
                partida._intentos = 0
                return True
            else:
                # os.system('clear')
                ...
                if result == 'Perdio':
                    print(
                        result,
                        '! Lo lamento, la palabra era: ', partida._palabra)
                    return True
    ...
    def dos_jugadores(self):
        ...
        dificultad1 = int(input(
            'Jugador 1: Ingrese una dificultad del 1 al 10'
            ' (1 --> dificil, 10 --> facil): '
            ))
        ...
        while partida1._intentos > 0:
            ...
            if result == 'Gano':
                print(
                    result,
                    '! Felicitaciones, la palabra era: ', partida1._palabra
                    )
                ...
                if result == 'Perdio':
                    print(
                        result,
                        '! Lo lamento, la palabra era: ', partida1._palabra
                        )
                    servicePartida.add_partida(partida1)
                    break
        print('------------------')
        ...
        dificultad2 = int(input(
            'Jugador 2: Ingrese una dificultad del 1 al 10'
            ' (1 --> dificil, 10 --> facil): '
            ))
        ...
        while partida2._intentos > 0:
            ...
            if result == 'Gano':
                print(
                    result,
                    '! Felicitaciones, la palabra era: ', partida2._palabra)
                ...
                if result == 'Perdio':
                    print(
                        result, '! Lo lamento, la palabra era: ',
                        partida2._palabra)
                    servicePartida.add_partida(partida2)
                    return True
